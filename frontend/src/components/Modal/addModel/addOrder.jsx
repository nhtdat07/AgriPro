...
export default function AddOrder() {
    ...
    const [products, setProducts] = useState([{ id: 1, name: "", exp_date: "", quantity:"", price:"", total:"" }]);

    const codeData = { code: "NH0000000040" };

    const addProduct = () => {
        setProducts([...products, { id: products.length + 1, name: "", exp_date: "", quantity:"", price:"", total:"" }]);
    };
    ...
    const resetForm = () => {
        setProducts([{ id: 1, name: "", exp_date: "", quantity: "", price: "", total: "" }]);
    };
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
                    <div className="bg-white rounded-lg shadow-md w-[500px] p-6">
                        ...
                        <p className="my-4 text-gray-700 text-lg leading-relaxed text-center">
                            Bạn có muốn lưu lại thông tin về đơn nhập hàng này?
                        </p>
                        <div className="flex justify-center gap-4 p-4">
