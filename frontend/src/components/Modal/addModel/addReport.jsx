...
export default function ExportReport({ dateRange, bestSellData, topCustomerData }) {
                    ...
                    <div className="flex flex-1 overflow-hidden px-6 pb-4 gap-4">
                        <div className="w-3/4 pr-2 border-r overflow-y-auto">
                            <form>
                                ...
                                {[
                                    { label: "Tổng lợi nhuận", value: dataReport.totalProfit, index: 0 },
                                    { label: "Số đơn nhập hàng", value: dataReport.numPurchase, index: 1 },
                                    { label: "Tổng số tiền nhập hàng", value: dataReport.valuePurchase, index: 2 },
                                    { label: "Số hóa đơn", value: dataReport.numSale, index: 3 },
                                    { label: "Tổng số tiền bán hàng", value: dataReport.valueSale, index: 4 },
                                    ...
                                    <div key={index} className="mb-4">
                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            <input
                                                ...
                                                onChange={(e) =>
                                                    index === 5
                                                    ? setTopProductsCount(e.target.value)
                                                    : setTopCustomersCount(e.target.value)
                                                }
                                            />
                                            <span className="text-sm">
                                                {index === 5 ? "sản phẩm bán chạy nhất" : "khách hàng mua nhiều nhất"}
                                            </span>
                                            <select
                                            ...
                                            <option value="không">không</option>
                                                ...
                                                <span className="text-sm">
                                            {index === 5 ? "kèm số lượng bán ra" : "kèm tổng tiền mua hàng"}
                                            </span>
                                            <img
                        ...
                        <div id="report-preview" className="w-1/2 overflow-y-auto p-4 text-[13px]">
                            <h3 className="font-bold text-center uppercase">{dataReport.agencyName}</h3>
                            <p className="text-center">Địa chỉ: {dataReport.address}</p>
                            <p className="text-center">Số điện thoại: {dataReport.phone}</p>
                            <p className="text-center mb-6">Mã số thuế: {dataReport.taxCode}</p>
