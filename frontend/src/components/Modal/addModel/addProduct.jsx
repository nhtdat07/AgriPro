...
import addPhoto from "../../../assets/images/plus.png";
                        ...
                        <form>
                            <div className="flex gap-4">
                                <div className="w-1/4 flex flex-col items-center">
                                    ...
                                    <div className="border p-2 flex items-center justify-center rounded-md">
                                ...
                                <div className="w-3/4">
                                    <div>
                                        ...
                                        <input type="text" className="w-full p-2 border rounded-md" placeholder="Tên sản phẩm" />
                                    </div>
                                    <div className="flex gap-4">
                                        <div className="w-1/2">
                                            <label className="p-2 block text-sm font-medium text-gray-700">Nhãn hiệu</label>
                                            <input type="text" className="w-full p-2 border rounded-md" placeholder="Nhãn hiệu" />
                                        </div>
                                        <div className="w-1/2">
                                    ...
                                    <div className="flex gap-4">
                                        <div className="w-1/2">
                                            ...
                                            <input type="text" className="w-full p-2 border rounded-md" placeholder="Nơi sản xuất" />
                                        </div>
                                        <div className="w-1/2">
                                            <label className="p-2 block text-sm font-medium text-gray-700">Giá bán</label>
                                            <input type="text" className="w-full p-2 border rounded-md" placeholder="Giá bán" />
                                        </div>
                                    </div>
                                    <div>
                                        <label className="p-2 block text-sm font-medium text-gray-700">Công dụng</label>
                                        <textarea className="w-full p-2 border rounded-md h-20" placeholder="Công dụng" ></textarea>
                                    </div>
                                    <div>
                                        <label className="p-2 block text-sm font-medium text-gray-700">Hướng dẫn sử dụng</label>
                                        <textarea className="w-full p-2 border rounded-md h-20" placeholder="Hướng dẫn sử dụng" ></textarea>
                                    </div>
                                </div>
                            </div>
                        </form>
