...
export default function ViewInvoice(props) {
  ...
  const invoiceData = {
    ...
    products: [
      { id: 1, name: "Thuốc trừ bệnh cây trồng COC85 - Gói 20 gram", quantity: 50, price: 13000 },
      { id: 2, name: "Thuốc trừ rệp sáp CONFIDOR 200SL", quantity: 40, price: 185000 },
    ],
  };

  const totalAmount = invoiceData.products.reduce((sum, product) => sum + product.quantity * product.price, 0);
