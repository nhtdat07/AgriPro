...
function Settings() {
  ...
  return (
    <main className="">
      ...
      <div className="px-4">
        {isChangingPassword ? (
          <div className="bg-white p-8 rounded-md shadow-md w-full mb-6">
            ...
            <div className="grid grid-cols-1 gap-4">
              ...
              <div className="flex gap-4 justify-center">
                <button
                  ...
                  className="bg-[#2c9e4b] text-white px-4 py-2 rounded-md"
                >
                  LƯU
                </button>
                <button
          ...
          <>
            <div className="bg-white p-6 rounded-md shadow-md relative mb-6">
            ...
            {isEditing ? (
              <div className="flex gap-4 mt-4 justify-center">
                <button
                  onClick={handleSave}
                  className="bg-[#2c9e4b] text-white px-4 py-2 rounded-md mb-6"
                >
                  LƯU
                </button>
                <button
                  onClick={handleCancel}
                  className="bg-gray-400 text-white px-4 py-2 rounded-md mb-6"
                >
                  HỦY
                </button>
              </div>
